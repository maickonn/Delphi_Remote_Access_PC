      ...
      begin
        ...
        begin
          case i of
            ...
            // Numpad
            96 .. 105:
              Socket2.SendText(intToStr(i - 96)); // Numpad  0..9
            106:
              Socket2.SendText('*');
            107:
              Socket2.SendText('&');
...
procedure TForm2.CheckBox2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = VK_SPACE then
    Key := 0;
end;

procedure TForm2.CheckBox1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = VK_SPACE then
    Key := 0;
end;
...
procedure TForm2.CheckBox3KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = VK_SPACE then
    Key := 0;
end;
